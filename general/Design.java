...
class CreditReport {
    ...
    public CreditReport(Customer customer, double calculatedScore, String riskLevel) {
    ...
    public String toString() {
        return "Customer: " + customer.getName() +
                ", Score: " + String.format("%.1f", calculatedScore) +
                ", Risk Level: " + riskLevel;
    }
}

// Interface for RiskAnalyzer
...
class CreditRiskAnalyzerImpl implements RiskAnalyzer {
    ...
    public CreditReport analyzeRisk(Customer customer) {
        ...
        double missedPaymentScore = 1.0 - Math.min(1.0, customer.getMissedPayments() / 10.0);
        double finalScore = (0.4 * incomeScore + 0.4 * debtScore + 0.2 * missedPaymentScore) * 100;
